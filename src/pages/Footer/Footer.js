...
const Footer = () => {
    return (
        <div className="relative mt-16 bg-[#323234]">
        <svg
          className="absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16 text-deep-purple-accent-400 text-[#323234]"
        ...
        <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
          ...
          <div className="flex flex-col justify-between pt-5 pb-10 border-t border-gray-200 sm:flex-row">
            <p className="text-sm text-gray-100">
              © Copyright 2022 Quick Food. All rights reserved.
            </p>
